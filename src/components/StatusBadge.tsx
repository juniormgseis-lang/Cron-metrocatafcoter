...
export function StatusBadge({ isConnected, isCalibrated, isLocked, timerState }: StatusBadgeProps) {
  return (
    <div className="flex flex-wrap gap-2 justify-center items-center mb-6">
      ...
      <div className={cn(
        "flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[9px] font-bold uppercase tracking-wider border whitespace-nowrap",
        ...
        {isCalibrated ? 'Hora Precisa' : 'Calibrando...'}
      </div>
      ...
      {/* Timer State */}
      <div className={cn(
        "px-2.5 py-1 rounded-full text-[9px] font-bold uppercase tracking-wider border transition-colors whitespace-nowrap",
